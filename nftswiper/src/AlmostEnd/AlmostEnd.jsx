  ...
  return (
    <section className="partners_sec">
      <div className="partners_title">
        <div>
           <h2 className='www'>Backed by the best</h2>
          <p className='qqq'>Lorem ipsum dolor sit amet, consectetur dolore adipiscing elit, sed do eiusmod tempor incididunt.</p>
        </div>
